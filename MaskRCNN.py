...
from FastRCNN import FasterRCNN, FastRCNNConvFCHead, RPNHead, _default_anchorgen
from ops.MultiScaleRoIAlign import MultiScaleRoIAlign
from backbone_own import Backbone
__all__ = [
    "MaskRCNN",
    "maskrcnn_FF_fpn_v2_own_backbone",
]
...
def maskrcnn_FF_fpn_v2_own_backbone(
    *,
    ...
    **kwargs: Any,
    ...
    backbone = Backbone(backbone_type  = backbone_type , version = version,freeze_at = 0)
    rpn_anchor_generator = _default_anchorgen()
    rpn_head = RPNHead(backbone.out_channels, rpn_anchor_generator.num_anchors_per_location()[0], conv_depth=2)
    box_roi_pool = MultiScaleRoIAlign(featmap_names=["0", "1", "2", "3","4","5","6","7","8"], output_size=7, sampling_ratio=2)
    box_head = FastRCNNConvFCHead(
        (backbone.out_channels, 7, 7), [256, 256, 256, 256], [1024], norm_layer=nn.BatchNorm2d
    )
    mask_roi_pool = MultiScaleRoIAlign(featmap_names=["0", "1", "2", "3","4","5","6","7","8"], output_size=14, sampling_ratio=4)
