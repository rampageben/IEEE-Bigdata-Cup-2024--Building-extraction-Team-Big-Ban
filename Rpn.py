...
from utils import Matcher, BalancedPositiveNegativeSampler, BoxCoder, _topk_min
...
class RegionProposalNetwork(torch.nn.Module):
    ...
    Args:
        ...
        softnms_thresh (float): Soft-NMS threshold used for postprocessing the RPN proposals
    ...
    def __init__(
        ...
        self.softnms_thresh = softnms_thresh
