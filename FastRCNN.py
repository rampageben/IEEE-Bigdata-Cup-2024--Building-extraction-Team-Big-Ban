...
def _default_anchorgen():
    anchor_sizes = ( (8,12,16,), (12,18,24,), (16,24,32,), (24,36,48,), (32,48,64,), (48,72,96,), (64,96,128,), (96,144,192,), (128, 192, 256,))
    aspect_ratios = ((0.35, 0.5, 0.75, 0.8, 0.85, 0.9, 0.95, 1.0, 1.05, 1.1, 1.2, 1.25, 1.35, 1.5, 1.75, 2.0, 2.25, 2.5, 2.75, 3.0),) * len(anchor_sizes)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        rpn = RegionProposalNetwork(
            ...
            softnms_thresh = rpn_softnms_thresh,
